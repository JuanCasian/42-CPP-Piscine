...
/*   Updated: 2019/05/02 20:56:02 by jcasian          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::danceAttack(std::string const &target) const {
...
void	FragTrap::peanutButterAttack(std::string const &target) const {
...
void	FragTrap::bubblesAttack(std::string const &target) const {
